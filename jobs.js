//define('jobs',[], function(require, exports, module){
    ...
    try {
        if (window.console && window.console.log) {
            console.image("http://sts0.mofang.com/statics/images/mofang_v2/mofang_logo_b3c69a6.png");
            setTimeout(function(){
                console.log("\n做专业的移动游戏推荐平台\n移动游戏玩家一站式服务平台\n游戏资讯，精彩视频\n深度攻略，精彩专区\n365不间断更新\n欢迎加入魔方网，加入魔方技术团队！\n");
                console.log("请将简历发送至 %c hr@mofang.com（邮件标题请注明应聘职位）", "color:red");
                console.log("职位介绍：http://www.mofang.com/about/join/");
            },1000);
        }
    } catch (e) { }
